...
export default function UseCases() {
  return (
    <div className="flex items-start flex-col justify-start w-screen h-screen relative">
      ...
      <h1 className="ml-8 text-xl mt-48 sm:mt-52 sm:text-4xl font-bold sm:font-extrabold mb-8 sm:mb-16 h-xs:text-lg h-xs:mb-2 h-xs:mt-36">
        Use Cases
      </h1>
      <ul className="ml-8 list-disc list-inside">
        <li className="text-md sm:text-xl h-xs:text-sm">
          Manufacturing Supply Chain Verification
        </li>
        <li className="text-md sm:text-xl h-xs:text-sm">
          Document Authentication
        </li>
        <li className="text-md sm:text-xl h-xs:text-sm">Digital Credentials</li>
        <li className="text-md sm:text-xl h-xs:text-sm">
