  ...
  return (
    <div className="w-10/12 mt-8 sm:w-2/3">
      ...
      <section className="mb-6 mt-8">
        ...
        <p>
          Welcome to UVerify, a service provided by Fabian Bormann. By accessing
      ...
      <section className="mb-6">
        ...
        <p>
          UVerify allows users to place hashes of raw text data or files on the
          Cardano blockchain. This service enables users to verify whether a
          document has been previously uploaded, ensuring its integrity and
          authenticity. Additionally, UVerify offers a white-label solution for
          certificate sites, allowing customization for different customers.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc list-outside">
          <li>
            Users access UVerify services through their Cardano wallet, with no
            traditional account creation required.
          </li>
          <li>
            Users are responsible for managing their own transaction fees on the
            Cardano network.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc list-outside">
          ...
          <li>
            ...
            (GPLv3). Users are free to use, modify, and distribute this software
            in accordance with the terms of the GPLv3 license. For more details,
            please refer to the{' '}
            <a
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc list-outside">
          ...
          <li>
            ...
            Accessing these links is at your own risk, and you should review the
            terms and privacy policies of any third-party sites you visit.
          </li>
          <li>
            UVerify disclaims any liability for any harm or damages arising from
            your use of third-party websites or services.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc list-outside">
          <li>
            UVerify provides the service "as is" and makes no representations or
            warranties of any kind, express or implied, regarding the operation
            of the service or the information, content, materials, or products
            included on this site.
          </li>
          <li>
            UVerify will not be liable for any damages of any kind arising from
      ...
      <section className="mb-6">
        ...
        <p>
          ...
          with the laws of Germany. You agree that any legal action or
          proceeding between you and UVerify for any purpose concerning these
          terms or the parties' obligations hereunder shall be brought
          exclusively in a court of competent jurisdiction sitting in Hannover,
